...
<!-- <link rel="stylesheet" href="<?=base_url()?>/css/Registro_Usuarios.css"> -->
...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
                ...
                <div class="">
                  <form id="datos" enctype="multipart/form-data" class="" method="post" action="<?=base_url()?>welcome/guardarUsuario">
                                        <div class="">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <br></br>
                                                                <input type="text" name="tipo_usuario" class="" id="user" placeholder=" " required /> </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="pwd">Usuario:</label>
                                            <br></br>
                                            <input type="text" name="usuario" class="" id="user" placeholder="Ej. kdbarrantes" required /> </div>
                    </div>
                    <div class="form-group">
                        <label for="pwd">Contrasena:</label>
                        <br></br>
                        <input type="text" name="password" class="" id="user" placeholder="Ej. 1234bhfd" required /> </div>
</div>
